...
init_path = os.path.join('screening_api', '__init__.py')
...
setup(
    ...
    packages=find_packages(include=('screening_api*',)),
    ...
    dependency_links=read_requirements('dependency_links.txt'),
    tests_require=read_requirements('requirements_dev.txt'),
    cmdclass={'test': PyTest},
    zip_safe=False,
    scripts=['bin/testdata-gen'],
)
