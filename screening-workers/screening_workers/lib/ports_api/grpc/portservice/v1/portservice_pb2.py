...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n%grpc/portservice/v1/portservice.proto\x12\x13grpc_portservice_v1\"\x07\n\x05\x45mpty\"\x91\x01\n\x08Position\x12\x11\n\ttype_code\x18\x01 \x01(\t\x12\x11\n\ttimestamp\x18\x02 \x01(\x05\x12\x0e\n\x06source\x18\x03 \x01(\t\x12\x10\n\x08latitude\x18\x04 \x01(\x02\x12\x11\n\tlongitude\x18\x05 \x01(\x02\x12\x14\n\x0csog_reported\x18\x06 \x01(\x02\x12\x14\n\x0c\x63og_reported\x18\x07 \x01(\x02\"\xcd\x01\n\x04Port\x12\x0c\n\x04\x63ode\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x14\n\x0c\x63ountry_code\x18\x03 \x01(\t\x12\x10\n\x08latitude\x18\x04 \x01(\x02\x12\x11\n\tlongitude\x18\x05 \x01(\x02\x12\x13\n\x0biso_country\x18\x06 \x01(\t\x12\x13\n\x0bport_source\x18\x07 \x01(\t\x12\x13\n\x0bihs_port_id\x18\x08 \x01(\t\x12\x19\n\x11world_port_number\x18\t \x01(\t\x12\x14\n\x0c\x63ountry_name\x18\n \x01(\t\"g\n\x0bPortHistory\x12\'\n\x04port\x18\x01 \x01(\x0b\x32\x19.grpc_portservice_v1.Port\x12\x17\n\x0ftimestamp_enter\x18\x02 \x01(\x05\x12\x16\n\x0etimestamp_exit\x18\x03 \x01(\x05\"$\n\x04\x44\x61ta\x12\r\n\x05\x66ield\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t2\xc9\x02\n\x08\x46indPort\x12M\n\x0f\x46indNearestPort\x12\x1d.grpc_portservice_v1.Position\x1a\x19.grpc_portservice_v1.Port\"\x00\x12\x41\n\x07GetPort\x12\x19.grpc_portservice_v1.Data\x1a\x19.grpc_portservice_v1.Port\"\x00\x12R\n\x10\x46indClosestPorts\x12\x1d.grpc_portservice_v1.Position\x1a\x19.grpc_portservice_v1.Port\"\x00(\x01\x30\x01\x12W\n\x0eGetPortHistory\x12\x1d.grpc_portservice_v1.Position\x1a .grpc_portservice_v1.PortHistory\"\x00(\x01\x30\x01\x62\x06proto3')
)
...
_PORT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='country_code', full_name='grpc_portservice_v1.Port.country_code', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='longitude', full_name='grpc_portservice_v1.Port.longitude', index=4,
      number=5, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='iso_country', full_name='grpc_portservice_v1.Port.iso_country', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='port_source', full_name='grpc_portservice_v1.Port.port_source', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ihs_port_id', full_name='grpc_portservice_v1.Port.ihs_port_id', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='world_port_number', full_name='grpc_portservice_v1.Port.world_port_number', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='country_name', full_name='grpc_portservice_v1.Port.country_name', index=9,
...
_PORTHISTORY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp_enter', full_name='grpc_portservice_v1.PortHistory.timestamp_enter', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp_exit', full_name='grpc_portservice_v1.PortHistory.timestamp_exit', index=2,
...
PortHistory = _reflection.GeneratedProtocolMessageType('PortHistory', (_message.Message,), {
